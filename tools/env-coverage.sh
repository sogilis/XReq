...
echo "Add to LIBRARY_PATH:     `pwd`/lib/coverage"
export LIBRARY_PATH="`pwd`/lib/coverage:$LIBRARY_PATH"

echo "Add to LD_LIBRARY_PATH:  `pwd`/lib/coverage"
export LD_LIBRARY_PATH="`pwd`/lib/coverage:$LD_LIBRARY_PATH"
