...
package body AdaSpec.CLI is
   ...
   begin
      ...
      Put_Line ("    sentance  and  a function to perform what  the sentance");
      Put_Line ("    describes.");
      Put_Line ("");
      Put_Line ("OPTIONS");
      Put_Line ("");
      ...
      Put_Line ("");
      Put_Line ("    -k, --keep-going             (NOT IMPLEMENTED)");
      Put_Line ("        Keep going if  there are  errors for a  feature and");
      Put_Line ("        compile the next feature.");
      Put_Line ("");
      Put_Line ("    -x, --executable TEST_NAME   (NOT IMPLEMENTED)");
      Put_Line ("        Create a test program  that will ne able to run all");
